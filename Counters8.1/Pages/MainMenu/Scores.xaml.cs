...
namespace Counters
{
    ...
    public sealed partial class Scores : MyToolkit.Paging.MtPage
    {
        ...
        private async void btnSendBySMS_Click(object sender, RoutedEventArgs e)
        {
            await Frame.NavigateAsync(typeof(ExportSend), new ExportParameter { Type = 1, ScoreId = selectedScore.ScoreId });
        }
    }
}
