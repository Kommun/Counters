            ...
            try
            {
                ...
                switch (tbType.SelectedIndex)
                {
                    ...
                    case 2:
                        ...
                        tbCounters.SelectionMode = ListPickerFlyoutSelectionMode.Multiple;
                        break;
                    case 3:
                        spData.Visibility = Visibility.Visible;
                        spCounters.Visibility = Visibility.Visible;
                        tbCounters.SelectionMode = ListPickerFlyoutSelectionMode.Single;
                        break;
                }
                if (tbCounters.SelectionMode == ListPickerFlyoutSelectionMode.Single)
